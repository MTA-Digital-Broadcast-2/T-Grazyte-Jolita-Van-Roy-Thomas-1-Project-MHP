...
public class HelloTVXlet_copy implements Xlet, HActionListener {
    
    private XletContext actueleXletContext;
    private HScene scene;
    private MijnComponent mc = new MijnComponent(200, 50, 300, 300);
    // debuggen âctiveren of niet
...
//        knop3.setActionCommand( "knop3-actioned" );
//        knop4.setActionCommand( "knop4_actioned" );
//        
        hulpKnop.setActionCommand("hulp");
        
        knop1.addHActionListener(this);
        knop2.addHActionListener(this); //( als deze knop gedrukt is JUIST)
